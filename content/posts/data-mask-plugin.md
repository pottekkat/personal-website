...
> [!NOTE]
> The values in `plugins` in the `config.yaml` file override those in the `config-default.yaml` file. If you want to use other plugins, copy it to the `config.yaml` file.
