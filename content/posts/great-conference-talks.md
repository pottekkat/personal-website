...
summary: "Practical, experience-driven, and often-overlooked ideas to improve your next developer conference talk."
description: Most talks are bad. And I don't mean kinda bad; I mean "why am I here, what am I doing, and when can I leave?" bad.
tags:
  - communication
  - education
  - speaking
...
The greatest talks I've been to—and the ones I've given—started with a clear goal. These goals weren't always complex; sometimes, it was just: I want Kubernetes users who have [never heard of the Kubernetes Gateway API](/posts/gateway-vs-ingress-api/) to understand why it was created and how they can try it with Apache APISIX. That's it. That level of clarity makes it easy to omit everything that doesn't help you get there.

And that's another problem: too many talks are full of details no one asked for. In my "[How is Apache APISIX Fast?](/posts/apisix-go-brr/)" talk, it would have been easy for me to go down the rabbit hole to explain Nginx internals and LuaJIT quirks, but it would have been too much for someone in the crowd who is already three talks in and is already thinking about lunch. Hiding the details isn't dumbing things down; it's respecting the listener's time and energy.
...
Thanks to [Abhishek Choudhary](https://x.com/shreemaan_abhi) for asking me to write this post.
