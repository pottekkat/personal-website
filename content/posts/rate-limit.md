...
tags: ["api gateway", "apache apisix", "tutorials"]
...
{{< figure src="/images/rate-limit/redis-counter.png#center" title="Storing the counter in Redis" caption="Now instead of each APISIX node having its own counter, it uses a shared counter" link="/images/rate-limit/redis-counter.png" target="_blank" class="align-center" >}}
