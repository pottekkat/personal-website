...
This article contains all the details of these programs. You can [skip to the summary](#summary) for quick access to all these resources.

## Google Summer of Code (GSoC)

| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Google Summer of Code (GSOC)](https://summerofcode.withgoogle.com/) | 10-22 Weeks (flexible) | [January 2024 - November 2024](https://developers.google.com/open-source/gsoc/timeline) | [$1500 - $6600](https://developers.google.com/open-source/gsoc/help/student-stipends) |
...
From 2022, [anyone above the age of 18 can participate in GSoC](https://opensource.googleblog.com/2021/11/expanding-google-summer-of-code-in-2022.html).

For 2024, mentees and organizations can choose the project time commitment and the project scope based on their ability to commit. Read the [announcement blog](https://opensource.googleblog.com/2023/11/google-summer-of-code-2024-celebrating-20th-year.html) for more details.
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [MLH Fellowship](https://fellowship.mlh.io/) | 12 Weeks | [January 30th - September 6th (3 batches year round)](https://fellowship.mlh.io/programs/open-source) | [Up to $5000 (need based)](https://help.mlh.io/en/articles/646017) |
...
MLH offers multiple fellowship tracks. See [fellowship.mlh.io](https://fellowship.mlh.io).

## Open Source Promotion Plan (OSPP)

| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Open Source Promotion Plan](https://summer-ospp.ac.cn/help/en/) | 6 months | [April - November (Applications due 4th June)](https://summer-ospp.ac.cn/help/en/timeline/) | [~$1000-$1700](https://summer-ospp.ac.cn/help/en/student/#5-student-bonus) |

> Open Source Promotion Plan is a summer program organized by the Open Source Software Supply Chain Promotion Plan of the Institute of Software Chinese Academy of Sciences. It aims to encourage college students to actively participate in developing and maintaining open source software and promote the vigorous development of an excellent open source software community.

[Apache APISIX is participating in OSPP](https://github.com/apache/apisix/wiki/Open-Source-Promotion-Plan-Summer-2024) this year. Feel free to check out our projects and reach out to me if you are interested in applying.

## Google Season of Docs (GSoD)

| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Google Season of Docs](https://developers.google.com/season-of-docs) | 6 Months | [February 2nd - December 13th](https://developers.google.com/season-of-docs/docs/timeline) | [Depends of budget of the organization](https://developers.google.com/season-of-docs/docs/tech-writer-payments) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Outreachy](https://www.outreachy.org/) | 3 Months | [May - August, December - March (Applications due September 2024)](https://www.outreachy.org/docs/applicant/#application-period) | [$7000](https://www.outreachy.org/docs/internship/#payments) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Season of KDE](https://mentorship.kde.org/sok/) | 3 Months | January - April (Applications due on January 8th 2024) | No (Certificates, merchandise, and swags provided) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Linux Kernel Mentorship Program](https://wiki.linuxfoundation.org/lkmp) | 12 Weeks Full-time, 24 Weeks Part-time | [March 1st - May 31st](https://docs.linuxfoundation.org/lfx/mentorship/mentorship-program-timelines), [June 1st - August 31st](https://docs.linuxfoundation.org/lfx/mentorship/mentorship-program-timelines), [September 1st - November 30th](https://docs.linuxfoundation.org/lfx/mentorship/mentorship-program-timelines) | [$3000 - $6600](https://docs.linuxfoundation.org/lfx/mentorship/mentee-stipends) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Linux Foundation Networking (LFN) Mentorship Program](https://wiki.lfnetworking.org/display/LN/LFN+Mentorship+Program) | 12 Weeks FT, 24 Weeks PT | [June 1st - August 31st (FT), June 1st - November 29th (PT)](https://wiki.lfnetworking.org/display/LN/LFN+Mentorship+Program#LFNMentorshipProgram-2024ProgramTimeline*) | [$3000 - $6600](https://docs.linuxfoundation.org/lfx/mentorship/mentee-stipends) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [GNOME Summer of Code](https://gsoc.gnome.org/) | 10-22 Weeks (flexible) | [January 2024 - November 2024](https://developers.google.com/open-source/gsoc/timeline) | [$1500 - $6600](https://developers.google.com/open-source/gsoc/help/student-stipends) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Alibaba Summer of Code](https://www.alibabacloud.com/campaign/summerofcode2020) | 3 Months | [May 25th - August 31st (2020, not announced for 2024)](https://www.alibabacloud.com/campaign/summerofcode2020) | Yes |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [FOSSASIA Codeheat](https://codeheat.org/) | Year round | [December - March](https://codeheat.org#timeline) | [Prizes for winners](https://codeheat.org/#faq) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Open Summer of Code](https://osoc.be/) | 24 days | [See Timeline](https://osoc.be/practical#When) | [No, but compensation for expenses](https://osoc.be/practical#Where) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Hyperledger Mentorship Program](https://wiki.hyperledger.org/display/INTERN/Hyperledger+Mentorship+Program) | 3 Months FT - 6 Months PT | [April 4th - November 29th](https://wiki.hyperledger.org/display/INTERN/Hyperledger+Mentorship+Program#HyperledgerMentorshipProgram-2024ProgramDates*) | [$3000 - $6600](https://docs.linuxfoundation.org/lfx/mentorship/mentee-stipends) |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Julia Seasons of Contributions (JSoC)](https://julialang.org/jsoc/) | - | Through GSoC, GSoD, and NumFOCUS Small Development Grants | Yes |
...
| Program Name                                                         | Duration            | Timeline                                                                              | Stipend                                                                                                    |
| -------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Summer of Haskell](https://summer.haskell.org/) | 10 Weeks, ˜3 Months | [Through GSoC](https://summerofcode.withgoogle.com/programs/2024/organizations/haskellorg) | [$1500 - $3300](https://developers.google.com/open-source/gsoc/help/student-stipends#total_stipend_amount) |
