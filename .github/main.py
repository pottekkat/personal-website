...
plt.rcParams.update({'axes.facecolor': '#161616e6'})
...
fig.savefig('./static/images/stats/monthly-visitors.png',
            dpi=300, bbox_inches='tight', transparent=False, facecolor="#161616e6")
...
plt.savefig('./static/images/stats/visitors-by-country.png', dpi=300, bbox_inches='tight', transparent=False, facecolor="#161616e6")
